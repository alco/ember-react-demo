  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    return {
      ...
      render: function render(context, env, contextualElement) {
        var dom = env.dom;
        var hooks = env.hooks, get = hooks.get, attribute = hooks.attribute, inline = hooks.inline, content = hooks.content, element = hooks.element;
        ...
        attribute(env, attrMorph0, element0, "style", get(env, context, "myStyle"));
        inline(env, morph0, context, "input", [], {"type": "text", "value": get(env, context, "color")});
        inline(env, morph1, context, "input", [], {"type": "range", "min": "200", "max": "1000", "value": get(env, context, "width")});
        content(env, morph2, context, "width");
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    ...
    return {
      ...
      render: function render(context, env, contextualElement) {
        ...
        var morph10 = dom.createMorphAt(dom.childAt(element4, [5]),0,0);
        var morph11 = dom.createMorphAt(dom.childAt(element4, [7]),0,0);
        var morph12 = dom.createMorphAt(dom.childAt(fragment, [12]),1,1);
        block(env, morph0, context, "link-to", ["ember-data"], {"activeClass": "selected"}, child0, null);
        block(env, morph1, context, "link-to", ["ember"], {"activeClass": "selected"}, child1, null);
        block(env, morph2, context, "link-to", ["react"], {"activeClass": "selected"}, child2, null);
        content(env, morph3, context, "routeTimings.ember-data.addMany");
        content(env, morph4, context, "routeTimings.ember-data.removeAll");
        content(env, morph5, context, "routeTimings.ember-data.removeSingle");
        content(env, morph6, context, "routeTimings.ember.addMany");
        content(env, morph7, context, "routeTimings.ember.removeAll");
        content(env, morph8, context, "routeTimings.ember.removeSingle");
        content(env, morph9, context, "routeTimings.react.addMany");
        content(env, morph10, context, "routeTimings.react.removeAll");
        content(env, morph11, context, "routeTimings.react.removeSingle");
  ...
  exports['default'] = Ember.HTMLBars.template((function() {
    var child0 = (function() {
      return {
        ...
        render: function render(context, env, contextualElement) {
          ...
          inline(env, morph0, context, "custom-item", [], {"param": get(env, context, "item"), "color": get(env, context, "item.color"), "width": get(env, context, "item.width"), "removeClicked": "removeItem"});
          return fragment;
        }
      };
    }());
    return {
      ...
      render: function render(context, env, contextualElement) {
        ...
        element(env, element1, context, "action", ["newItem"], {});
        element(env, element2, context, "action", ["addManyItems"], {});
        element(env, element3, context, "action", ["removeAllItems"], {});
...
if (runningTests) {
  ...
  require("many-components-ember/app")["default"].create({"name":"many-components-ember","version":"0.0.0.1531ee4b"});
}
